# Customer Dialogue Runtime

> Repository: 1325863889-design/customer-dialogue-runtime  
> Status: portfolio-ready source package

## Overview

A customer-dialogue runtime that organizes state tracking, command parsing, flow execution, response generation, and service-channel adapters.
...
- Dialogue flow and state orchestration
- Action execution and tool integration
- Multi-channel service interfaces
- Business data and graph-data connectors

## Technology Stack

Python, FastAPI, Socket.IO, MySQL, Neo4j, LLM services
...
Install dependencies from `src`, configure model and database connections, then start the CLI or API service entrypoint.
