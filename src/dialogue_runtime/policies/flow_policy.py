...
from dialogue_runtime.policies.base_policy import Policy, PolicyConfig, PolicyPrediction
from dialogue_runtime.dialogue_understanding.flow import FlowExecutor, FlowsList
from dialogue_runtime.dialogue_understanding.stack.stack_frame import FlowStackFrame
from dialogue_runtime.shared.constants import ACTION_LISTEN

if TYPE_CHECKING:
    from dialogue_runtime.core.tracker import DialogueStateTracker
    from dialogue_runtime.core.domain import Domain
...
class FlowPolicy(Policy):
    ...
    def _preset_slot_to_collect_if_needed(
        ...
        # 检查下一步是否是 collect 步骤
        from dialogue_runtime.dialogue_understanding.flow.flow import StepType
