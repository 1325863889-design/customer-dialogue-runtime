...
from dialogue_runtime.shared.constants import (
    DEFAULT_SERVER_HOST,
    DEFAULT_SERVER_PORT,
)
from dialogue_runtime.channels.base_channel import UserMessage

if TYPE_CHECKING:
    from dialogue_runtime.agent.agent import Agent
...
class AtguiguServer:
    ...
    def _register_routes(self, app: FastAPI) -> None:
        ...
        async def root():
            """根路径健康检查。"""
            from dialogue_runtime import __version__
            return {
                "status": "ok",
                "version": __version__,
